...
const FrameComponent1: NextPage<FrameComponent1Type> = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[53px] box-border max-w-full text-left text-17xl text-black font-montserrat ${className}`}
    >
      <div
